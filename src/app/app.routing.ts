...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/journal'
    {path: '', pathMatch : 'full', redirectTo: 'journal'},

    // Redirect signed in user to the '/journal'
    //
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'check-data', loadChildren: () => import('app/modules/admin/check-data/check-data.module').then(m => m.CheckDataModule)},
